...
export default class NotifService {
  ...
  public async search() {
    const body = {
      moduleName: 'admin',
      orgFilter: { onlyOrgSearch: false, orgList: [], directOrgAssociation: true },
      startRowIndex: 1,
      searchName: 'NotifMsgPopover',
      selectList: [
        'Pk',
        'MgrId',
        'VerNumber',
      ...
      sortTermList: [{ descending: true, fullName: 'Pk' }],
      resultLimit: 11,
      searchTermList: [
        {
          attribute: {
            name: 'VirtualMgrId',
            value: [11100, 10547, 11702, 10739, 10706, 10732, 11708, 50462],
          },
          operator: 'in',
        },
        { attribute: { name: 'NotifInfo', value: 'null' }, operator: 'isNotNull' },
      ],
    };
    ...
    var body = {
      ...
      appCommand: {
        ...
        appCommandParams: [
          ...
          { name: 'ActionType', value: 'MARKASREAD' },
        ],
      },
      objectIdentifiers: [
        {
